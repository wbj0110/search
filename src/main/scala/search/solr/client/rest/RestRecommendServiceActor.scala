package search.solr.client.rest
...
import search.solr.client.domain.Failure
import search.solr.client.entity.{ScreenCloud, MergeCloud, Msg}
import search.solr.client.ui.RecommendUI
...
/**
  * REST Service
  */
trait RestService extends HttpService with Logging with Configuration with spray.httpx.SprayJsonSupport {

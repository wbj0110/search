package search.solr.client.storage.mongo;
...
public class MongoStorage {
    ...
    private static <T> void saveEntity(T t, List<Object> savedObjects) throws search.solr.client.storage.mongo.MongoException {
        ...
        if (t instanceof ObjectId || primitiveTypeSet.contains(clazz)) {
            ...
            try {
                ...
                throw new search.solr.client.storage.mongo.MongoException(savedObjects, e);
            }
        }
    }
    ...
    public static <T> boolean saveEntity(T t) {
        ...
        try {
            ...
            savedObjects = list;
            isSuccessful = true;
        } catch (search.solr.client.storage.mongo.MongoException e) {
